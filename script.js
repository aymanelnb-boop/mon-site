...
const POPULAR_FR = [
  ...
  {twitch:'jltomy',nom:'JLTomy'},{twitch:'leronron71',nom:'LeRonRon71'},
  {twitch:'soledalsole',nom:'soledalsole'},{twitch:'sh0wtie',nom:'sh0wtie'},
  {twitch:'callmejasmine',nom:'CallMeJasmine'},{twitch:'nemesia_8',nom:'nemesia_8'},
  {twitch:'abaraii',nom:'Abaraii'},{twitch:'hlib_tv',nom:'Hlib_tv'},
  {twitch:'ouahleouff',nom:'Ouahleouff'},{twitch:'nasdas_off',nom:'nasdas_off'},
  {twitch:'naavi_',nom:'Naavi_'},{twitch:'manglouste',nom:'Manglouste'},
  {twitch:'enjoyphoenix',nom:'EnjoyPhoenix'},{twitch:'moman',nom:'MoMaN'},
  {twitch:'sabouu12',nom:'sabouu12'},{twitch:'loupiote3',nom:'Loupiote3'},
  {twitch:'melhssn_',nom:'MelHssn_'},{twitch:'skallow',nom:'Skallow'},
  {twitch:'wazcoach',nom:'Wazcoach'},{twitch:'comp_lol',nom:'comp_lol'},
  {twitch:'aliciacia_',nom:'aliciacia_'},{twitch:'oxyz_on',nom:'Oxyz_On'},
  {twitch:'pokimane',nom:'pokimane'},{twitch:'kaicenat',nom:'KaiCenat'},
  {twitch:'moumousx',nom:'MoumouSx'},{twitch:'adilrami23',nom:'adilrami23'},
  {twitch:'hakaiwrld',nom:'hakaiwrld'},{twitch:'qassimiento',nom:'Qassimiento'},
  {twitch:'alicerpz',nom:'Alicerpz'},{twitch:'theguill84',nom:'TheGuill84'},
  {twitch:'chowh1',nom:'chowh1'},{twitch:'mastu',nom:'Mastu'},
  {twitch:'antoinedaniel',nom:'AntoineDaniel'},{twitch:'nico_la',nom:'Nico_la'},
  {twitch:'flamby',nom:'Flamby'},{twitch:'joyca',nom:'Joyca'},
  {twitch:'kraize__',nom:'Kraize__'},{twitch:'dzmomo_13',nom:'DzMomo_13'},
  {twitch:'fugu_fps',nom:'fugu_fps'},{twitch:'harley5_',nom:'harley5_'},
  {twitch:'emilielemaitre',nom:'emilielemaitre'},{twitch:'skiitty_',nom:'Skiitty_'},
  {twitch:'milesaana',nom:'MileSaana'},{twitch:'lyannha',nom:'Lyannha'},
  {twitch:'nenetttte',nom:'Nenetttte'},{twitch:'noto_off',nom:'Noto_Off'},
  {twitch:'manyboyyy',nom:'ManyBoyyy'},{twitch:'mrsal_59',nom:'MrSal_59'},
  {twitch:'anyme023',nom:'Anyme023'},{twitch:'skyyart',nom:'Skyyart'},
  {twitch:'lesparodiebros',nom:'LesParodieBros'},{twitch:'beyaz',nom:'beyAz'},
  {twitch:'nyhroo z',nom:'NyHrOoZ'},{twitch:'fatiiiih',nom:'Fatiiiih'},
  {twitch:'samueletienne',nom:'samueletienne'},{twitch:'yartog_ml',nom:'Yartog_ML'},
  {twitch:'latreizz',nom:'LaTreizz'},{twitch:'mehdoche',nom:'Mehdoche'},
  {twitch:'sratuke',nom:'Sratuke'},{twitch:'sanouk21',nom:'Sanouk21'},
  {twitch:'stundzow',nom:'StundZow'},{twitch:'bilyxssss',nom:'Bilyxssss'},
  {twitch:'iaamshiroo',nom:'iaamshiroo'},{twitch:'aneyaris_',nom:'Aneyaris_'},
  {twitch:'sixentv',nom:'SixenTv'},{twitch:'icijaponcorp',nom:'IciJaponCorp'},
  {twitch:'viggy_night',nom:'Viggy_Night'},{twitch:'bayliix',nom:'BayLiiX'},
  {twitch:'hawnie',nom:'Hawnie'},{twitch:'emstazy',nom:'Emstazy'},
  {twitch:'mmenaeh',nom:'Mmenaeh'},{twitch:'tobias',nom:'Tobias'},
  {twitch:'hayzaa',nom:'Hayzaa'},{twitch:'hamzakerdaloco',nom:'HamzaKerdaloco'},
  {twitch:'adamchico_',nom:'AdamChico_'},{twitch:'kaffworld',nom:'KaffWorld'},
  {twitch:'legrotv',nom:'LegroTV'},{twitch:'magikzera',nom:'MAGiKzera'},
  {twitch:'juniorlej_',nom:'JuniorLeJ_'},{twitch:'rmcsport',nom:'RMCsport'},
  {twitch:'byilhann',nom:'byilhann'},{twitch:'jerem',nom:'Jerem'},
  {twitch:'papesан',nom:'PapeSan'},{twitch:'jlnexol',nom:'JLNexol'},
  {twitch:'jennyyl',nom:'JennyL'},{twitch:'azaryaah',nom:'Azaryaah'},
  {twitch:'soon',nom:'SoOn'},{twitch:'sunsunsai',nom:'Sunsunsai'},
  {twitch:'helydia',nom:'helydia'},{twitch:'valorant_fr',nom:'VALORANT_fr'},
  {twitch:'ndapointvirgule',nom:'NdaPointVirgule'},{twitch:'sermaax',nom:'Sermaax'},
  {twitch:'ravennrust',nom:'ravennrust'},{twitch:'tmaxks',nom:'TMAXKS'},
  {twitch:'hak0tv',nom:'Hak0TV'},{twitch:'jltomysao',nom:'jltomysao'},
  {twitch:'packam',nom:'Packam'},{twitch:'mickalow',nom:'Mickalow'},
  {twitch:'nikof',nom:'Nikof'},{twitch:'usoppxvi',nom:'usoppxvi'},
  {twitch:'furax22',nom:'Furax22'},{twitch:'ultrajoblife',nom:'UltrasJoblife'},
  {twitch:'laytho_',nom:'Laytho_'},{twitch:'nobreak0',nom:'Nobreak0'},
  {twitch:'roidemon_',nom:'RoiDEMON_'},{twitch:'sleyercool',nom:'sleyercool'},
  {twitch:'ap_rose',nom:'AP_R0se'},{twitch:'jltomy___',nom:'jltomy___'},
  {twitch:'crumzeii',nom:'Crumzeii'},{twitch:'miira__',nom:'Miira__'},
  {twitch:'maximeblaggi',nom:'MaximeBlaggi'},{twitch:'aenot',nom:'Aenot'},
  {twitch:'liberto',nom:'Liberto'},{twitch:'jlnqs',nom:'JLNQs'},
  {twitch:'bichouu_',nom:'Bichouu_'},{twitch:'camelia',nom:'Camelia'},
  {twitch:'samy_stv',nom:'Samy_sTV'},{twitch:'wsh_tv',nom:'WSH_TV'},
  {twitch:'momotehna_',nom:'MomoTehna_'},{twitch:'khadim',nom:'Khadim'},
  {twitch:'wardak_',nom:'WarDak_'},{twitch:'jl_zefir',nom:'JL_ZEFIR'},
  {twitch:'novalitoo',nom:'Novalitoo'},{twitch:'shreik_',nom:'Shreik_'},
  {twitch:'jieltoot',nom:'JielToot'},{twitch:'pnl',nom:'PNL'},
  {twitch:'wati',nom:'Wati'},{twitch:'spockiller_tv',nom:'spockiller_tv'},
  {twitch:'killystia',nom:'Killystia'},{twitch:'kaatsup',nom:'Kaatsup'},
  {twitch:'kmsenkangoo',nom:'KmSenKangoo'},{twitch:'nikos',nom:'Nikos'},
  {twitch:'jlmelenchon',nom:'JLMelenchon'},{twitch:'krolay',nom:'Krolay'},
  {twitch:'pollynette',nom:'Pollynette'},{twitch:'ammar_bsr',nom:'ammar_bsr'},
  {twitch:'waolol1',nom:'Waolol1'},{twitch:'rainbow6fr',nom:'Rainbow6FR'},
  {twitch:'mgg_fr',nom:'MGG_FR'},{twitch:'roro_27o',nom:'roro_27o'},
  {twitch:'wylenz',nom:'Wylenz'},{twitch:'serendippp',nom:'serendippp'},
  {twitch:'seelamelol',nom:'Seelamelol'},{twitch:'benaset',nom:'Benaset'},
  {twitch:'gamingo',nom:'Gamingo'},{twitch:'manatylo l',nom:'ManatyLoL'},
  {twitch:'darkmels',nom:'darkmels'},{twitch:'littlebigwhale',nom:'LittleBigWhale'},
  {twitch:'gom4rt',nom:'Gom4rt'},{twitch:'angledroit',nom:'AngleDroit'},
  {twitch:'ultia',nom:'Ultia'},{twitch:'nacked',nom:'Nacked'},
  {twitch:'jovaa_zou',nom:'jovaa_zou'},{twitch:'valhаlatv',nom:'ValhalaTV'},
  {twitch:'elixia_tv',nom:'Elixia_TV'},{twitch:'kalaveraх3',nom:'KaLaVeRaX3'},
  {twitch:'eriaanais',nom:'EriaAnais'},{twitch:'oni_',nom:'Oni_'},
  {twitch:'dvm_medja',nom:'DVM_Medja'},{twitch:'pauleta_twitch',nom:'Pauleta_Twitch'},
  {twitch:'otplol_',nom:'otplol_'},{twitch:'oonolive',nom:'Oonolive'},
  {twitch:'cornovr',nom:'CornoVR'},{twitch:'fares_salvatoree',nom:'fares_salvatoree'},
  {twitch:'yassencore',nom:'YassEncore'},{twitch:'sherazadesmh',nom:'SherazadeSmh'},
  {twitch:'blazx',nom:'BLAZX'},{twitch:'jowan_tv',nom:'Jowan_TV'},
  {twitch:'theorus_',nom:'Theorus_'},{twitch:'sora',nom:'Sora'},
  {twitch:'idater',nom:'Idater'},{twitch:'slu_pure',nom:'slu_pure'},
  {twitch:'fana',nom:'Fana'},{twitch:'nekzioh',nom:'NekzioH'},
  {twitch:'mannylesprit',nom:'Mannylesprit'},{twitch:'zeaaron_',nom:'ZeAaron_'},
  {twitch:'mastaa',nom:'Mastaa'},{twitch:'kperiods',nom:'kPeriods'},
  {twitch:'c_achlys',nom:'C_Achlys'},{twitch:'tontongalsen',nom:'TontonGalsen'},
  {twitch:'nemdude',nom:'Nemdude'},{twitch:'solaryfortnite',nom:'SolaryFortnite'},
  {twitch:'mrbboy45',nom:'MrBboy45'},{twitch:'pirastack',nom:'PirAStack'},
  {twitch:'rxseda',nom:'Rxseda'},{twitch:'aidenshowtv',nom:'AidenShowTV'},
  {twitch:'jlarkyzus',nom:'JLArkyzus'},{twitch:'moustaki9',nom:'Moustaki9'},
  {twitch:'fakemonster',nom:'Fakemonster'},{twitch:'kailussss',nom:'Kailussss'},
  {twitch:'damstwich',nom:'DAMsTwitch'},{twitch:'casca',nom:'Casca'},
  {twitch:'aalifaxx',nom:'AALIFAXX'},{twitch:'haalifaxx_',nom:'haalifaxx_'},
  {twitch:'yuhitv',nom:'YuhITV'},{twitch:'pokemclash',nom:'pokemclash'},
  {twitch:'noujbi',nom:'Noujbi'},{twitch:'akthereal',nom:'AkTheReal'},
  {twitch:'zarga_flf',nom:'zarga_flf'},{twitch:'kada',nom:'Kada'},
  {twitch:'tiar_a',nom:'Tiar_a'},{twitch:'yog_newbie',nom:'YOG_Newbie'},
  {twitch:'professeurimpulse',nom:'professeurimpulse'},{twitch:'floriannguyen',nom:'Floriannguyen'},
  {twitch:'gansuto_',nom:'Gansuto_'},{twitch:'heloise_',nom:'Helolise_'},
  {twitch:'jlyousiris',nom:'JLYousiris'},{twitch:'fionapolitain',nom:'Fionapolitain'},
  {twitch:'pakabinks',nom:'Pakabinks'},{twitch:'jlxxvictormoraisxxotf',nom:'JLxxVictorMoraisxxOTF'},
  {twitch:'sabrirng',nom:'SabriRNG'},{twitch:'dalil667',nom:'Dalil667'},
  {twitch:'zipperr',nom:'Zipperr'},{twitch:'cyrilmp4',nom:'CYRILmp4'},
  {twitch:'quent2_',nom:'quent2_'},{twitch:'bayonetta_tv',nom:'Bayonetta_TV'},
  {twitch:'zerator',nom:'ZeratoR'},{twitch:'kamet0',nom:'Kamet0'},
  {twitch:'michou',nom:'Michou'},{twitch:'inoxtag',nom:'Inoxtag'},
  {twitch:'alderiate',nom:'Alderiate'},{twitch:'amaru',nom:'Amaru'},
  {twitch:'theomalini',nom:'TheoMalini'},{twitch:'c_jane',nom:'C_Jane'},
  {twitch:'aminerire',nom:'aminerire'},{twitch:'davymourier',nom:'davymourier'},
  {twitch:'ninidu35',nom:'ninidu35'},{twitch:'zoro_kozuki',nom:'Zoro_Kozuki'},
  {twitch:'sardoche',nom:'Sardoche'},{twitch:'critixorg',nom:'cRiTiXorg'},
  {twitch:'shamssou212',nom:'Shamssou212'},{twitch:'adeemovic',nom:'adeemovic'},
  {twitch:'moudryk',nom:'_moudryk'},{twitch:'sludeina',nom:'Sludeina'},
  {twitch:'alvaena',nom:'Alvaena'},{twitch:'narkuss_lol',nom:'Narkuss_lol'},
  {twitch:'bounty182',nom:'bounty182'},{twitch:'juan13__',nom:'Juan13__'},
  {twitch:'jlnonotwitch',nom:'JLnonoTwitch'},{twitch:'anisspastis',nom:'anisspastis'},
  {twitch:'chanux69',nom:'chanux69'},{twitch:'roozaxx',nom:'RoozaXx'},
  {twitch:'seaufi',nom:'Seaufi'},{twitch:'dimitri______',nom:'dimitri______'},
  {twitch:'soldat_tunisien',nom:'Soldat_Tunisien'},{twitch:'jlsylvain59',nom:'JLSylvain59'},
  {twitch:'djamel',nom:'Djamel'},{twitch:'bilou',nom:'Bilou'},
  {twitch:'celiaaxvi',nom:'CeliaaXVI'},{twitch:'pere_blackkou',nom:'Pere_BlacKkou'},
  {twitch:'azergamelive',nom:'AzerGameLIVE'},{twitch:'merine82',nom:'Merine82'},
  {twitch:'skartiz',nom:'SkarTiz'},{twitch:'obraonlive',nom:'ObraOnLive'},
  {twitch:'le_patatos1030',nom:'Le_Patatos1030'},{twitch:'pekenioo_',nom:'PEKENIOO_'},
  {twitch:'squeezie',nom:'Squeezie'},{twitch:'baadbunni',nom:'baadbunni'},
  {twitch:'jlkayz_',nom:'JLKayz_'},{twitch:'lz_haamaa',nom:'LZ_haamaa'},
  {twitch:'rookie1__',nom:'Rookie1__'},{twitch:'aminematue',nom:'aminematue'},
  {twitch:'vitality',nom:'Vitality'},{twitch:'gotaga',nom:'Gotaga'},
  {twitch:'boblegob',nom:'BOBLEGOB'},{twitch:'mowraa',nom:'Mowraa'},
  {twitch:'domingo',nom:'Domingo'},{twitch:'kryy213',nom:'Kryy213'},
  {twitch:'rebeudecter',nom:'RebeuDeter'},{twitch:'w_endy',nom:'W_endy'},
  {twitch:'polahtv',nom:'PolahTV'},{twitch:'skafoucie',nom:'SkafouCie'},
  {twitch:'grostonyy_',nom:'GrosTonyy_'},{twitch:'teaqo',nom:'Teaqo'},
  {twitch:'adztv',nom:'AdzTV'},{twitch:'mushway',nom:'Mushway'},
  {twitch:'kennyoffi',nom:'KennyOffi'},{twitch:'ste_up',nom:'Ste_Up'},
  {twitch:'vicinho',nom:'Vicinho'},{twitch:'jlclowe',nom:'JLClowe'},
  {twitch:'minos',nom:'Minos'},{twitch:'misaow3b',nom:'MisaoW3B'},
  {twitch:'locklear',nom:'Locklear'},{twitch:'fg_guiiz',nom:'FG_GuiiZ'},
  {twitch:'teeqzy_',nom:'Teeqzy_'},{twitch:'chebkumaa',nom:'CHEBKUMAA'},
  {twitch:'mxthieutv',nom:'MxthieuTV'},{twitch:'julobss',nom:'JulobsS'},
  {twitch:'xo_trixy',nom:'xo_trixy'},{twitch:'veerdose',nom:'VeerDosE'},
  {twitch:'zwave',nom:'Zwave'},{twitch:'sodlire',nom:'SoDLire'},
  {twitch:'lebousheu_gaming',nom:'LeBousheu_Gaming'},{twitch:'xewer',nom:'XEWER'},
  {twitch:'ipromx',nom:'iProMx'},{twitch:'malek_csgo',nom:'maleK_CSGO'},
  {twitch:'lenoxtv_',nom:'LenoxTV_'},{twitch:'kennadp',nom:'KennaDP'},
  {twitch:'xalgus',nom:'Xalgus'},{twitch:'twincytv',nom:'TwincyTV'},
  {twitch:'jlyoussox93',nom:'JLYoussox93'},{twitch:'lebouseuh',nom:'LeBouseuh'},
  {twitch:'lutti',nom:'Lutti'},{twitch:'areliann',nom:'Areliann'},
  {twitch:'doigby',nom:'Doigby'},{twitch:'juliettearz',nom:'JulietteArz'},
  {twitch:'imeelk',nom:'iMeelk'},{twitch:'malariatv',nom:'MaLaRiaTV'},
  {twitch:'hellsey_',nom:'Hellsey_'},{twitch:'smiteless_',nom:'Smiteless_'},
  {twitch:'kreeks',nom:'Kreeks'},{twitch:'17nassim',nom:'17Nassim'},
  {twitch:'remx',nom:'Remx'},{twitch:'kaazn',nom:'KaazN'},
  {twitch:'lolypokicake',nom:'LolyPokicake'},{twitch:'gameinterventionn',nom:'Gameinterventionn'},
  {twitch:'prince_off',nom:'PRINCE_OFF'},{twitch:'jlfranklin_',nom:'JLFranklin_'},
  {twitch:'kobeadc',nom:'KobeADC'},{twitch:'hariis13_',nom:'Hariis13_'},
  {twitch:'saitaike',nom:'Saitaike'},{twitch:'martav',nom:'Martav'},
